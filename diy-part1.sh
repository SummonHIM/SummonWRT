...
# Tools
echo 'src-git luci-app-diskman https://github.com/lisaac/luci-app-diskman.git;master' >>feeds.conf.default
echo 'src-git openwrt-iptvhelper https://github.com/riverscn/openwrt-iptvhelper.git;master' >>feeds.conf.default
echo "src-git natelol https://github.com/natelol/natelol.git" >> feeds.conf.default
echo "src-git wrtbwmon https://github.com/brvphoenix/wrtbwmon.git;master" >> feeds.conf.default
echo "src-git luci-app-wrtbwmon https://github.com/brvphoenix/luci-app-wrtbwmon.git;master" >> feeds.conf.default
...
#echo 'src-git MentoHUST-OpenWrt-ipk https://github.com/KyleRicardo/MentoHUST-OpenWrt-ipk.git;master' >>feeds.conf.default
#echo 'src-git luci-app-mentohust https://github.com/BoringCat/luci-app-mentohust.git;master' >>feeds.conf.default
